...
**Решение:** Проверьте, что PostgreSQL запущен и строки подключения правильные

### Проблема: 401 Unauthorized при обращении к API
**Решение:** 
- Убедитесь, что вы вошли в систему
- Проверьте срок действия токена
- Перезайдите для получения нового токена

### Проблема: DateTime ошибка с PostgreSQL
**Решение:** Уже исправлена! См. `DATETIME_FIX.md`

### Проблема: SignalR не подключается
**Решение:**
- Проверьте CORS настройки
- Убедитесь, что JWT токен передается через query string для WebSocket

## Дополнительная документация

- `VUE_FRONTEND_SETUP.md` - 🆕 **Полное руководство по Vue 3 фронтенду**
- `QUICK_START_SIGNALR.md` - ⚡ Быстрый старт для тестирования SignalR (5 минут)
- `SIGNALR_TROUBLESHOOTING.md` - Подробная отладка SignalR уведомлений
- `DATETIME_FIX.md` - Исправление проблемы DateTime
- `TESTING_AUTH.md` - Инструкции по тестированию
